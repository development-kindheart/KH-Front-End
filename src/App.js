      ...
      <ChatContextProvider>
        <Router>
          ...
          <Routes>
            ...
            <Route
              path="/signupstore"
              element={isLoggedIn ? <Layout /> : <SignupStore />}
            />
            <Route
              path="/login"
            ...
            <Route
              path="/chat"
              element={isLoggedIn ? <ChatHome /> : <Layout />}
            />
            <Route
              path="/open-room"
              element={isLoggedIn ? <Room /> : <Login />}
            />
            <Route
              path="/forgotpassword"
            ...
            <Route
              path="/resetpassword"
              element={isLoggedIn ? <Layout /> : <ResetPassword />}
            />
          ...
          /> */}
            ...
            {/* Graphically reprensentation (totol no of store and total amount of donation)*/}
              <Route
                path="/dashboard"
                element={role === "foundation" && <Dashboard />}
              />
              ...
              <Route
                ...
                element={role === "foundation" && <Widget />}
              />
              {/* Assign widgets to store */}
              <Route
                path="/dashboard/store"
                element={role === "foundation" && <Store />}
              />
              ...
              <Route
                path="/store/donation"
                element={role === "store" && <StoreDonation />}
              />
              <Route
              ...
              <Route
                path="/admin/donation"
                element={role === "admin" && <AdminDonation />}
              />
              <Route
                path="/admin/store"
                element={role === "admin" && <AdminStore />}
              />
              <Route
